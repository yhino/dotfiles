...
nnoremap <silent> <C-u><C-u> :<C-u>UniteWithBufferDir -buffer-name=files buffer file_mru file file/new<CR>
inoremap <silent> <C-u><C-u> <ESC>:<C-u>UniteWithBufferDir -buffer-name=files buffer file_mru file file/new<CR>
" unite.vim上でのキーマッピング
